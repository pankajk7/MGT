...
public class EditKellyDay{
	...
	public EditKellyDay(Context context)
	{
		this.context=context;
	}
	
	public void createEditKellyDayLayout(KellyDayEntity objKellyDayEntity) {
	try
	{	
		...
		.getLayoutInflater().inflate(R.layout.edit_kelly_day,
				null);
		baseLayout.removeAllViews();
		baseLayout.addView(inflateLayout);
		
		CalendarEvents.stateBackButtonString="KellyDaySummary";
		idString=objKellyDayEntity.id;		
		
		dateEditText=(EditText)((CalendarEvents) context).findViewById(R.id.edittext_editkellyday_selectdate);
		repeatEditText=(EditText)((CalendarEvents) context).findViewById(R.id.edittext_editkellyday_repeat);
		shareYesButton=(Button)((CalendarEvents) context).findViewById(R.id.btn_editkellyday_share_yes);
		shareNoButton=(Button)((CalendarEvents) context).findViewById(R.id.btn_editkellyday_share_no);
		deleteButton=(Button)((CalendarEvents)context).findViewById(R.id.btn_editkellyday_delete);
		dateEditText.setText(objKellyDayEntity.date);
		repeatEditText.setText(objKellyDayEntity.repeat);	
		
		currentTimeString=MgtDateFormat.dateFormatMMDDYYYYTIMECalendar(objKellyDayEntity.date);
...
//		dateEditText.setText(MgtDateFormat.dateFormatYYMMDDTime(currentTimeString));
		...
		if(objKellyDayEntity.isShare.equals("true")){
	...
	deleteButton.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			new CommonDeleteFunction().delete(context, eventNameString, idString, "Kelly Day Deleted successfully", "KellyDaySummary");
...
//					shareYesButton.setEnabled(true);
		...
		addCalendarButton=(Button)((CalendarEvents)context).findViewById(R.id.btn_editkellyday_calendar);
...
//							dataEngine.postKellyDayTest();	
						...
						protected void onPostExecute(Void result) {
							...
							{
								dlgAlert.setMessage("KellyDay updated successfully");
							}
							else
							{
