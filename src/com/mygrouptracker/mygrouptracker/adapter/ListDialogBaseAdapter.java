...
public class ListDialogBaseAdapter extends BaseAdapter{

	Context context;
	ArrayList<MemberGroupType> stringList;
	LayoutInflater inflater;
	
	public ListDialogBaseAdapter(Context context, ArrayList<MemberGroupType> stringList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		text.setText(stringList.get(position).groupName);
